...
<head>
    ...
    <style>
        ...
        .digital-number {
            ...
            text-align: center;
            font-size: 1rem; /* Ukuran mobile */
        }
        @media (min-width: 768px) {
            .digital-number { font-size: 1.5rem; }
        }
...
<body class="w-screen bg-slate-100 lg:h-screen lg:grid lg:grid-rows-[auto_1fr_auto_auto] lg:overflow-hidden">

    <header class="bg-white py-2 px-4 sm:px-6 flex justify-between items-center border-b border-slate-200 shadow-sm">
        <div>
        ...
        <div id="live-clock" class="bg-slate-100 text-slate-700 p-2 lg:p-3 rounded-lg text-center">
            <p class="text-xs lg:text-lg font-semibold whitespace-nowrap">Memuat jam...</p>
        </div>
    </header>

    <main class="bg-slate-100 p-2 min-h-0">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-2 h-full">
                ...
                <div class="bg-white rounded-lg shadow-md p-2 h-full flex flex-col border border-slate-200">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-2 mb-2">
                        ...
                        <div class="col-span-2 bg-slate-100 p-2 rounded-lg flex flex-col items-center justify-center">
                            <span class="text-slate-600 font-semibold text-xs mb-1">JUMLAH JAM KERJA</span>
            ...
            <div class="bg-white rounded-lg shadow-md p-4 flex flex-col h-full border border-slate-200">
                <h3 class="text-base lg:text-lg font-semibold text-center mb-2 text-slate-800">Pos Kesehatan STAR</h3>
                <div class="flex-shrink-0">
                    <img src="{{ asset('images/medical.jpg') }}" alt="Pemeriksaan Kesehatan" class="w-full h-32 lg:h-40 rounded-md object-cover">
                </div>
                <ul class="mt-2 list-disc list-inside space-y-1 text-xs lg:text-sm flex-grow font-medium text-slate-600">
    ...
    <div class="bg-slate-800 text-white text-center text-sm md:text-lg font-bold py-1 md:py-2 px-2">
        UTAMAKAN KESELAMATAN DAN KESEHATAN KERJA
    </div>

    <footer class="bg-white p-2 border-t border-slate-200">
        <div class="grid grid-cols-5 gap-2">
            ...
            <div class="bg-slate-100 rounded-lg p-2 text-center flex flex-col justify-center">
                ...
                <p class="text-blue-600 text-xl lg:text-4xl font-bold">{{ $value }}</p>
            </div>
            @endforeach
        </div>
    </footer>
